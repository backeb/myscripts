...
motu_client_name = '/nird/home/bjornb/Git/mytools/cmems/motu-client-python/motu-client.py'
...
for iyear in range(StartYear,StopYear,1):
    Year = str(iyear)
    if not os.path.exists(os.getcwd()+"/"+str(iyear)):
        os.makedirs(os.getcwd()+"/"+str(iyear))
    for imonth in range(1,13,1):
        ...
        for iday in range(1,ndays+1,1):
            ...
            SaveFileName=os.getcwd()+"/"+str(iyear)+'/'+'MERCATOR-PHY-24-'+Year+'-'+Month+'-'+Day+'-12.nc'
            print SaveFileName
